...
(function (factory) {
    ...
    var Comments = {
        ...
        events: {
            ...
            // Other actions
            'click li.comment .action.upvote': 'upvoteComment',
            'click li.comment .action.downvote': 'downvoteComment', // Custom
            'click li.comment .action.delete.enabled': 'deleteComment',
        ...
        getDefaultOptions: function () {
            return {
                ...
                // User
                profilePictureURL: 'https://www.w3schools.com/images/w3schools_green.jpg',
                ...
                textareaPlaceholderText: 'Додај',
                newestText: 'најновије',
                oldestText: 'најстарије',
                popularText: 'најпосјећеније',
                attachmentsText: 'запис',
                sendText: 'шаљи',
                replyText: 'одговори',
                editText: 'измијени',
                editedText: 'измијењено',
                youText: 'Ви',
                saveText: 'сними',
                deleteText: 'обриши',
                newText: 'ново',
                viewAllRepliesText: 'погледај свих __replyCount__ одговора',
                hideRepliesText: 'сакриј одговоре',
                noCommentsText: 'нема примједби',
                noAttachmentsText: 'нема записа',
                attachmentDropText: 'овдхе спусти запис',
                ...
                downvoteComment: function (commentJSON, success, error) { success(commentJSON) }, // Custom
        ...
        createUpvoteElement: function (commentModel) {
            ...
            var upvoteIcon = $('<i/>', {
                ...
                'style': 'margin-right: 5px;' // Add spacing
            });

            var upvoteCount = $('<span/>', {
                'class': 'upvote-count',
                text: commentModel.upvoteCount != null ? commentModel.upvoteCount : 0
            });

            upvote.append(upvoteIcon).append(upvoteCount);
            return upvote;
        },
        ...
        createDownvoteElement: function (commentModel) {
            var downvote = $('<button/>', {
                'class': 'action downvote' + (commentModel.userHasDownvoted ? ' highlight-font' : ''),
            ...
            var downvoteCount = $('<span/>', {
                'class': 'downvote-count',
                text: commentModel.downvoteCount != null ? commentModel.downvoteCount : 0
            });

            downvote.append(downvoteIcon).append(downvoteCount);
            return downvote;
        },
        ...
        upvoteComment: function (ev) {
            ...
            if (commentModel.userHasUpvoted) {
                ...
                commentModel.upvoteCount++;
                commentModel.userHasUpvoted = true;
                if (commentModel.userHasDownvoted) {
                    commentModel.downvoteCount--;
                    commentModel.userHasDownvoted = false;
                }
            }
        ...
        downvoteComment: function (ev) {
            ...
            console.log('Downvote clicked through delegate. Current model:', commentModel);
            console.log('Current downvoteCount:', commentModel.downvoteCount, 'Type:', typeof commentModel.downvoteCount);
            ...
            if (commentModel.userHasDownvoted) {
                ...
                commentModel.downvoteCount++;
                commentModel.userHasDownvoted = true;
                if (commentModel.userHasUpvoted) {
                    commentModel.upvoteCount--;
                    commentModel.userHasUpvoted = false;
                }
            ...
            console.log('New downvoteCount:', commentModel.downvoteCount);
        ...
        reRenderUpvotes: function (commentId) {
            ...
            var count = commentModel.upvoteCount;
            if (count === null || count === undefined) count = 0;
            upvoteEl.find('.upvote-count').text(count);
            if (count > 0) {
                upvoteEl.find('.upvote-count').css('display', 'inline-block');
            } else {
                upvoteEl.find('.upvote-count').css('display', 'none');
            }
        },
        ...
        reRenderDownvotes: function (commentId) {
            ...
            console.log('Count to render:', commentModel.downvoteCount);

            downvoteEl.toggleClass('highlight-font', commentModel.userHasDownvoted);
            var count = commentModel.downvoteCount;
            if (count === null || count === undefined) count = 0;

            // Set text explicitly
            downvoteEl.find('.downvote-count').text(count);

            // Toggle visibility using inline style to ensure override
            if (count > 0) {
                downvoteEl.find('.downvote-count').css('display', 'inline-block');
            } else {
                downvoteEl.find('.downvote-count').css('display', 'none');
            }
        },
        ...
        createCommentWrapperElement: function (commentModel) {
            ...
            var downvotes = this.createDownvoteElement(commentModel); // Custom

            // Append buttons for actions that are enabled
            if (this.options.enableReplying) actions.append(reply);
            if (this.options.enableUpvoting) actions.append(upvotes);
            if (this.options.enableDownvoting) actions.append(downvotes); // Custom
